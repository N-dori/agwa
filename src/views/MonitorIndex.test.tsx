...
const mockedGetInitialSensorData = pyMonitorService.getInitialSensorData as jest.Mock
const mockedSendSensorData = pyMonitorService.sendSensorData as jest.Mock
...
it('opens the modal and fetches problematic readings when Inspect (in PodIndex) is clicked', async () => {
  ...
  const mockedGetAlerts = pyMonitorService.getAlerts as jest.Mock
