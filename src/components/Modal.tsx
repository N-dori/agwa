  ...
  return (
   type === modalTypes.INTRO ? 
    <section className="modal-container flex-col flex-jc">
      ...
      <p className="intro">
        After reading the articles on AGWA's website, I was truly impressed by the technological capabilities of your growing cabin — specifically, how it can precisely adapt the living conditions for each plant and deliver high-quality results. This kind of innovation fascinates me personally.
