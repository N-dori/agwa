...
describe('PodsIndex', () => {
    ...
    it('renders a massage with Unit Status ', () => {
        render(<PodsIndex
            ...
            unitId={'123'}
            onInspectUnit={() => {}}
            status={{status:'', classification: classificationsTypes.HEALTHY}}
            />
        )
    ...
    it('renders a massage with Unit Status ', () => {
        render(<PodsIndex
            ...
            unitId={'123'}
            onInspectUnit={() => {}}
            status={{status:'', classification: classificationsTypes.NEEDS_ATTENTION}}
            />
        )
        const unitStatus = screen.getByTestId('unit-status')
    ...
    it('calls onInspectUnit when Inspect button is clicked', () => {
        ...
        render(
            ...
            pods={[]}
            unitId={'123'}
            onInspectUnit={mockOnInspectUnit}
            status={{status:'', classification: classificationsTypes.HEALTHY}}
            />
        );
