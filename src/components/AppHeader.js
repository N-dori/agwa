...
export const AppHeader = () => {
    ...
    return (_jsx("section", { className: "header-container flex-jc-ac", children: _jsx("div", { className: "logo-container img-wrapper", children: _jsx("img", { src: logoSrc, alt: "image of logo" }) }) }));
};
